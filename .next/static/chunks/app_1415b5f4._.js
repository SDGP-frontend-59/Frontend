(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_1415b5f4._.js", {
...
"[project]/app/constructor/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function LicensedPage() {
    ...
    // Backend data states
    const [licenseData, setLicenseData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [announcementsError, setAnnouncementsError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Fetch license and royalty data from backend
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LicensedPage.useEffect": ()=>{
            const fetchData = {
                "LicensedPage.useEffect.fetchData": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        // Fetch license data
            ...
            }["LicensedPage.useEffect.fetchData"];
            fetchData();
        }
    }["LicensedPage.useEffect"], []);
    // Fetch announcements from backend
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LicensedPage.useEffect": ()=>{
            const fetchAnnouncements = {
                "LicensedPage.useEffect.fetchAnnouncements": async ()=>{
                    try {
                        setAnnouncementsLoading(true);
                        setAnnouncementsError(null);
                        const response = await fetch('https://ceylonminebackend.up.railway.app/miner/announcements');
            ...
            }["LicensedPage.useEffect.fetchAnnouncements"];
            fetchAnnouncements();
        }
    }["LicensedPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LicensedPage.useEffect": ()=>{
            const handleThemeChange = {
                "LicensedPage.useEffect.handleThemeChange": (event)=>{
                    setIsDarkMode(event.detail.isDarkMode);
                }
            }["LicensedPage.useEffect.handleThemeChange"];
            const handleLanguageChange = {
                "LicensedPage.useEffect.handleLanguageChange": (event)=>{
                    setLanguage(event.detail.language);
                }
            }["LicensedPage.useEffect.handleLanguageChange"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LicensedPage.useEffect": ()=>{
            ...
            window.addEventListener('resize', onWindowResize);
            const animate = {
                "LicensedPage.useEffect.animate": ()=>{
                    requestAnimationFrame(animate);
                    particlesMesh.rotation.x += 0.0002 + mouseY * 0.0002;
                    particlesMesh.rotation.y += 0.0002 + mouseX * 0.0002;
                    renderer.render(scene, camera);
            ...
            animate();
            const updateParticleColor = {
                "LicensedPage.useEffect.updateParticleColor": ()=>{
                    particlesMaterial.color.set(isDarkMode ? 0xD2B48C : 0xFFD700);
                }
            }["LicensedPage.useEffect.updateParticleColor"];
            const themeChangeListener = {
                "LicensedPage.useEffect.themeChangeListener": ()=>{
                    updateParticleColor();
                }
            }["LicensedPage.useEffect.themeChangeListener"];
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: [
                                ...
                                announcementsLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-sm",
                                    ...
                                    lineNumber: 1276,
                                    columnNumber: 15
                                }, this) : announcementsError ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(LicensedPage, "OgXXg+2dToXCv2ZJi5G/SWa4b6o=", false, function() {
    return [
...
_c = LicensedPage;
var _c;
__turbopack_context__.k.register(_c, "LicensedPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=app_1415b5f4._.js.map