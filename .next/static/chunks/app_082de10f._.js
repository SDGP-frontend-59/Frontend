(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_082de10f._.js", {
...
"[project]/app/minemore/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MiningEducation() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MiningEducation.useEffect": ()=>{
            const handleThemeChange = {
                "MiningEducation.useEffect.handleThemeChange": (event)=>{
                    setIsDarkMode(event.detail.isDarkMode);
                    updateThree(event.detail.isDarkMode);
                }
            }["MiningEducation.useEffect.handleThemeChange"];
            window.addEventListener('themeChange', handleThemeChange);
            return ({
                "MiningEducation.useEffect": ()=>{
                    window.removeEventListener('themeChange', handleThemeChange);
    ...
    const updateThree = (isDark)=>{
        if (sceneRef.current) {
            // Update THREE.js particle color based on theme
            sceneRef.current.traverse((obj)=>{
                if (obj instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Points"] && obj.material) {
                    obj.material.color.set(isDark ? 0xD2B48C : 0x555555);
                }
            });
        }
    ...
    const scaleTransform = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(scrollYProgress, [
        0,
        1
    ], [
        1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MiningEducation.useEffect": ()=>{
            ...
            window.addEventListener('resize', onWindowResize);
            const animate = {
                "MiningEducation.useEffect.animate": ()=>{
                    requestAnimationFrame(animate);
                    particlesMesh.rotation.x += 0.0005 + mouseY * 0.0005;
                    particlesMesh.rotation.y += 0.0005 + mouseX * 0.0005;
                    renderer.render(scene, camera);
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: courses.map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>setActiveSlide(index),
                                                className: `w-3 h-3 rounded-full ${index === activeSlide ? 'bg-orange-500' : isDarkMode ? 'bg-white bg-opacity-50' : 'bg-gray-900 bg-opacity-50'}`
                                            }, index, false, {
                                                fileName: "[project]/app/minemore/page.tsx",
...
_s(MiningEducation, "27Ku7UgVKNDOxTuLJ8xK6ZYzv2g=", false, function() {
    return [
...
_c = MiningEducation;
var _c;
__turbopack_context__.k.register(_c, "MiningEducation");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=app_082de10f._.js.map