...
function Home() {
    ...
    const ImageSlider = ()=>{
        ...
        const nextImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
            "Home.ImageSlider.useCallback[nextImage]": ()=>{
                setCurrentSlide({
                    "Home.ImageSlider.useCallback[nextImage]": (prev)=>prev === images.length - 1 ? 0 : prev + 1
                }["Home.ImageSlider.useCallback[nextImage]"]);
            }
        }["Home.ImageSlider.useCallback[nextImage]"], [
            images.length
    ...
    _s1(ImageSlider, "yGFS7mdfAEaGuA/z2IzZvCF/urs=");
    const features = [
        {
            id: 1,
            title: "DIGITAL LICENSING",
...
_s(Home, "6xWo1gVTML70xwzgl+v4Yl/EoJ8=", false, function() {
    return [
